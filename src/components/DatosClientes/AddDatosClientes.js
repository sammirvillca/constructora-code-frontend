...
const AddDatosClientes = () => {
  ...
  const saveDatosCliente = async (e) => {
    e.preventDefault();
    console.log("Guardando datos cliente...");
    ...
    await axios.post("http://localhost:8080/api/v1/datos-cliente", formData, {
      headers: {
  ...
  return (
    <div className="container" style={{ marginTop: "20px" }}>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <h2>Agregar Datos Cliente</h2>
      </div>
      <div className="py-4">
        <form onSubmit={saveDatosCliente}>
...
export default AddDatosClientes;