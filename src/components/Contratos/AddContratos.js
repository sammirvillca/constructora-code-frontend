...
const AddContratos = () => {
  ...
  const fetchClientesNoVinculados = async () => {
    try {
      const response = await axios.get("http://localhost:8080/api/v2/propiedades-no-vinculados");
  ...
  const fetchDibujoPlanosNoVinculados = async () => {
    try {
      const response = await axios.get("http://localhost:8080/api/v2/dibujo-plano-no-vinculados");
  ...
  const saveContrato = async (e) => {
    ...
    try {
      await axios.post("http://localhost:8080/api/v2/contrato-plano", formData, {
        headers: {
    ...
    <div className="container" style={{ marginTop: "20px" }}>
      ...
      <div className="py-4">
        <form onSubmit={saveContrato}>
          ...
          <div className="mb-4 row">
            <label className="col-sm-2 col-form-label" htmlFor="contractDocument">
          ...
          <div className="mb-4 row">
            <label className="col-sm-2 col-form-label">Dirección de Propiedad</label>
            <div className="col-sm-4">
              <input
                type="text"
                className="form-control"
